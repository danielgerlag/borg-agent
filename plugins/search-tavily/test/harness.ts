...
export function createTavilyHarness(options?: {
  ...
  return {
    ...
    secrets,
    tools,
    invokeStatus: () => bus.invoke(tavilyGetStatus as never, {} as never),
    invokeConnect: () => bus.invoke(tavilyConnect as never, {} as never),
    invokeDisconnect: () => bus.invoke(tavilyDisconnect as never, {} as never),
    activate: () => createTestHarness(tavilyPlugin, context),
  };
}
